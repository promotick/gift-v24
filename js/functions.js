(function($){
    ...
    function init_popup(){
        if($(window).width() + boutique_get_scrollbar_width() >= 768){
            if($('body').hasClass('home')){
                ...
                $.magnificPopup.open({
                  items: {
                    src: '<div class="white-popup"><div class="kt-popup-newsletter"><div class="popup-title"><img src="./images/welcome.png"/></div></div></div>',  //can be a HTML string, jQuery object, or CSS selector
                    type: 'inline'
                  }
                });
            }
    ...
    function init_popup_beyond(){
      if($(window).width() + boutique_get_scrollbar_width() >= 768){
          if($('body').hasClass('home-beyond')){
              //Open directly via API
              $.magnificPopup.open({
                items: {
                  src: '<div class="white-popup"><div class="kt-popup-newsletter"><div class="popup-title"><img src="../images/welcome.png"/></div></div></div>',  //can be a HTML string, jQuery object, or CSS selector
